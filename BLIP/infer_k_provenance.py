...
sufficient_provenance_strategy_pool = ['embedding_sufficient_top_down','embedding_sufficient_bottem_up','LLM_score_sufficient_bottem_up','LLM_score_sufficient_top_down'] 
...
if __name__ == "__main__":
    ...
    for data in dataset: 
        ...
        provenance_run_topk(data, data_folder, embedding_folder, result_folder, model_name, num_case)
